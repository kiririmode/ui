						...
						<div class="col-xs-12">
							<div class="panel panel-default">
								<div class="panel-heading">
									<p>
										プロジェクト詳細画面 <span class="pull-right"> <n:a
												href="/action/project/edit/${projectId}"
												cssClass="btn btn-raised btn-success">変更</n:a> <n:a
												id="topReturnList" href="#"
												cssClass="btn btn-raised btn-default">戻る</n:a>
										</span>
									</p>
								</div>
								...
								<div class="panel-body">
									<table class="table table-striped table-hover table-bordered">
										<tbody>
											...
											<tr>
												<th>プロジェクトマネージャー</th>
												<td><n:write name="form.projectManager" /></td>
											</tr>
											<tr>
												<th>プロジェクトリーダー</th>
												<td><n:write name="form.projectLeader" /></td>
											</tr>
											<tr>
												<th>顧客名</th>
												<td><n:write name="form.clientId" /> <n:write
														name="form.clientName" /></td>
											</tr>
											<tr>
												<th>プロジェクト開始日</th>
												<td><n:write name="form.projectStartDate"
														valueFormat="exampleDateTime{yyyy/MM/dd}" /></td>
											</tr>
											<tr>
												<th>プロジェクト終了日</th>
												<td><n:write name="form.projectEndDate"
														valueFormat="exampleDateTime{yyyy/MM/dd}" /></td>
											</tr>
											<tr>
												<th>備考</th>
												<td><n:write name="form.note" /></td>
											</tr>
											<tr>
												<th>売上高</th>
												<td><n:write name="form.sales"
														valueFormat="decimal{###,###,### 千円}" /></td>
											</tr>
											<tr>
												<th>売上原価</th>
												<td><n:write name="form.costOfGoodsSold"
														valueFormat="decimal{###,###,### 千円}" /></td>
											</tr>
											<tr>
												<th>販管費</th>
												<td><n:write name="form.sga"
														valueFormat="decimal{###,###,### 千円}" /></td>
											</tr>
											<tr>
												<th>本社配賦</th>
												<td><n:write name="form.allocationOfCorpExpenses"
														valueFormat="decimal{###,###,### 千円}" /></td>
											</tr>
											<tr>
												<td>売上総利益</td>
