                    ...
                    <p>
                      <n:forInputPage>
                        ...
                        <span class="pull-right">
                          <n:button id="topBackLink" uri="#" cssClass="btn btn-raised btn-default btn-sm">戻る</n:button>
                          <n:button uri="/action/project/confirmOfCreate" cssClass="btn btn-raised btn-success btn-sm">登録</n:button>
                        </span>
                      </n:forInputPage>
                    ...
                    <table class="table table-striped table-bordered table-condensed">
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <div class="form-group">
                              <n:text name="form.projectName" maxlength="64" cssClass="form-control" errorCss="input-error" />
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="form-group">
                              <n:text name="form.projectManager" maxlength="64" cssClass="form-control " errorCss="input-error"/>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="form-group">
                              <n:text name="form.projectLeader" maxlength="64" cssClass="form-control " errorCss="input-error"/>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <n:forInputPage>
                              <n:a href="/action/client/index" id="client_pop"><span class="glyphicon glyphicon-search" /></n:a>
                            </n:forInputPage>
                            <n:error errorCss="bg-danger" name="form.clientId" />
                            <n:error errorCss="bg-danger" name="form.clientName" />
                          </td>
                        </tr>
                        <tr>
                          <th>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="form-group">
                              ...
                              <n:error errorCss="bg-danger" name="form.validProjectPeriod" />
                            </div>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td>
                            <n:forInputPage>
                              <div class="form-group">
                                ...
                                <div style="clear:left;"><n:error errorCss="bg-danger" name="form.sales" /></div>
                              </div>
                            </n:forInputPage>
                            <n:forConfirmationPage>
                          ...
                          <td>
                            <n:forInputPage>
                              <div class="form-group">
                                ...
                                <div style="display:table-cell;height:30px;vertical-align:bottom;">千円</div>
                                <div style="clear:left;"><n:error errorCss="bg-danger" name="form.costOfGoodsSold" /></div>
                              </div>
                            </n:forInputPage>
                            <n:forConfirmationPage>
                          ...
                          <td>
                            <n:forInputPage>
                              <div class="form-group">
                                ...
                                <div style="display:table-cell;height:30px;vertical-align:bottom;">千円</div>
                                <div style="clear:left;"><n:error errorCss="bg-danger" name="form.sga" /></div>
                              </div>
                            </n:forInputPage>
                            <n:forConfirmationPage>
                          ...
                          <td>
                            <n:forInputPage>
                              <div class="form-group">
                                ...
                                <div style="display:table-cell;height:30px;vertical-align:bottom;">千円</div>
                                <div style="clear:left;"><n:error errorCss="bg-danger" name="form.allocationOfCorpExpenses" /></div>
                              </div>
                            </n:forInputPage>
                            <n:forConfirmationPage>
                        ...
                        <n:forConfirmationPage>
                          <tr>
                            ...
                            <td>
                              ...
                              <n:error errorCss="bg-danger" name="form.grossProfit" />
                            </td>
                          </tr>
                          <tr>
                            <td>
                            ...
                            <td>
                              ...
                              <n:error errorCss="bg-danger" name="form.profitBeforeAllocation" />
                            </td>
                          </tr>
                          <tr>
                            <td>
                            ...
                            <td>
                              ...
                              <n:error errorCss="bg-danger" name="form.profitRateBeforeAllocation" />
                            </td>
                          </tr>
                          <tr>
                            <td>
                            ...
                            <td>
                              ...
                              <n:error errorCss="bg-danger" name="form.operatingProfit" />
                            </td>
                          </tr>
                          <tr>
                            <td>
                            ...
                            <td>
                              ...
                              <n:error errorCss="bg-danger" name="form.operatingProfitRate" />
                            </td>
                          </tr>
                        </n:forConfirmationPage>
                      </tbody>
